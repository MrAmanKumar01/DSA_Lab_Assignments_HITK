...
public class KruskalsAlgo {
    ...
    // graph creation using Edge List method
    ...
    public static void kruskalsMST(ArrayList<Edge> edges, int V) {
        init(); //whenever we use Union-find we must call init() to make par[i] = i
        ...
        System.out.println("Final(Min.) cost of MST is: " + mstCost);
    }
